...
# --------------------------------------------------------------------------- #
CONFIG = {
    "pipeline_id": "bigbio:quantmsdiann",
    # entry name -> template / params file / required-input schema key.
    # "" is the single-entry case (no -entry flag).
    "entries": {
        "": {
            "template": "run_bigbio_quantmsdiann.sh",
            "params_file": "params.yml",
            "input_flag": "input",
            "input_var": "sdrf",  # bash variable in the template holding the input path
        },
    },
    ...
    "species_map": {'database': 'protein_fasta'},
}
